...
impl CssColorProfileAtRule {
    ...
    pub fn block(&self) -> SyntaxResult<CssDeclarationListBlock> {
...
pub struct CssColorProfileAtRuleFields {
    ...
    pub name: SyntaxResult<CssIdentifier>,
    pub block: SyntaxResult<CssDeclarationListBlock>,
}
#[derive(Clone, PartialEq, Eq, Hash)]
...
impl CssContainerAtRule {
    ...
    pub fn block(&self) -> SyntaxResult<CssRuleListBlock> {
...
pub struct CssContainerAtRuleFields {
    ...
    pub block: SyntaxResult<CssRuleListBlock>,
}
#[derive(Clone, PartialEq, Eq, Hash)]
...
impl AstNode for AnyCssKeyframesSelector {
    type Language = Language;
    const KIND_SET: SyntaxKindSet<Language> =
        CssKeyframesIdentSelector::KIND_SET.union(CssKeyframesPercentageSelector::KIND_SET);
    fn can_cast(kind: SyntaxKind) -> bool {
        matches!(
            kind,
...
impl IntoIterator for &CssKeyframesItemList {
    type Item = CssKeyframesItem;
    type IntoIter = AstNodeListIterator<Language, CssKeyframesItem>;
    fn into_iter(self) -> Self::IntoIter {
        self.iter()
    }
}
